#pragma checksum "C:\Users\Dinora\Desktop\HabitTracker\HabitTracker\Views\Home\Habit.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "fe70b3fc3f05ba6b55ff3f3e2ca557aee2462c23"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"fe70b3fc3f05ba6b55ff3f3e2ca557aee2462c23", @"/Views/Home/Habit.cshtml")]
    ...
    angular
        ...
        .controller('CreateController', ['$scope', '$http', '$location', '$filter', function ($scope, $http, $location, $filter) {
            ...
            $scope.saveHabit = function () {
                $scope.habit.startDate = $filter('date')($scope.startDate, ""yyyy-MM-dd HH:mm:ss"");
                $http.post('http://localhost:47547/api/Habit/', $scope.habit)
        ...
        .controller('DetailsController', ['$scope', '$http', '$routeParams', function ($scope, $http, $routeParams) {
            ...
            $http.get('http://localhost:47547/api/Habit/' + $routeParams.habitId)
                .then(function (res) {
                    ...
                    $scope.edit.repeat = $filter('repeatType')($scope.edit.repeat);
                });

        }])
        .control");
            WriteLiteral(@"ler('EditDeleteController', ['$scope', '$http', '$location', '$routeParams', function ($scope, $http, $location, $routeParams) {
